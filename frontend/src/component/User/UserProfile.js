          ...
          <div className="flex justify-center fixed inset-0 z-10  flex-col-reverse items-center bg-slate-900 h-screen">
            <div className="w-[80%] max-w-lg bg-slate-800 p-2 rounded-lg">
              ...
              {fields.map((field, index) => (
                <div
                  key={index}
                  className=" bg-slate-700 text-white rounded-md my-2 p-2"
                >
                  <p className="m-2 flex justify-between font-bold ">
                    {field.label}{" "}
                    <Link state={location.pathname} to="/user/updatepassword">
                      {" "}
                      <MdEdit
                        className={`${
                          field.label === "Password" ? `text-xl` : `hidden`
                        }`}
                      />
                    </Link>
                  </p>
            ...
            <div className=" w-[80%] flex justify-between flex-row-reverse gap-10 max-w-lg ">
              <button
                ...
                className="flex items-center my-2 gap-2 p-2 bg-red-400 rounded-md"
              >
                Logout <MdLogout />
              </button>
              {/* <button
