    ...
    <>
      <div className="fixed inset-0 z-10 bg-slate-900 flex flex-col items-center justify-center text-white pb-20">
        ...
        <p className="text-center mb-6 px-10 max-w-5xl">
          Thank you for choosing rentAll Project! To access the full range of
          features, please verify your account by clicking the button below.
        </p>
        <button
          onClick={handleVerification}
          className="bg-green-500 active:bg-green-600 py-2 px-4 rounded"
        >
          Verify
        </button>
      </div>
